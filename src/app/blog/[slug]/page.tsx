...
function BlogContent({ post, allPosts }: { post: PostData, allPosts: PostData[] }) {
    if (!post) {
        notFound();
    }
...
// We keep this as a server-side component for metadata generation,
// but we will render a client component that fetches its own data.
export default function BlogPostPage({ params }: { params: { slug: string } }) {
  ...
  return <BlogContent post={post} allPosts={allPosts} />;
}
