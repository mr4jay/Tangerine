        ...
        <div className="grid gap-8 lg:grid-cols-3 text-center lg:text-left">
          ...
          <div className="flex flex-col items-center lg:items-end gap-4">
             ...
             <div className="flex items-center gap-2">
                ...
                <Button asChild variant="ghost" size="icon" aria-label="LinkedIn Profile"><Link href="https://www.linkedin.com/in/rajure-ajay-kumar" target="_blank" rel="noopener noreferrer"><Linkedin className="h-6 w-6 text-primary" /></Link></Button>
