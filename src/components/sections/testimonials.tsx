...
const testimonials = [
  {
    ...
    author: 'John Doe',
    role: 'Director of Analytics, Omnicom',
  ...
  {
    quote: "The customer churn prediction model Ajay developed was a game-changer, directly contributing to a 20% increase in customer retention for Novartis. His machine learning skills are exceptional.",
    author: 'Samuel Green',
  ...
  },
  {
    ...
    author: 'Jane Smith',
    role: 'Product Manager, Technvision',
